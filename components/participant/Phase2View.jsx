  ...
  return (
    <>
      ...
      <div className="grid gap-8 px-10 py-8 lg:grid-cols-[1fr_320px]">
        <div>
          {!unlocked ? (
            <div className="mb-8 rounded-[10px] border border-fl-red/20 bg-fl-red/5 p-12 text-center fl-fade-in">
              <div className="mb-4 text-5xl">🔒</div>
              <h2 className="text-xl font-extrabold">Codebase swap happens at lunch</h2>
            ...
            <div className="mb-8 rounded-[10px] border border-fl-red/20 bg-gradient-to-br from-fl-red/10 to-fl-red/5 p-8 text-center fl-fade-in">
              <div className="mb-3 text-5xl">📦</div>
              <h2 className="text-xl font-extrabold">Your Assigned Codebase</h2>
              ...
              {swapData?.repo_url && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-4 inline-flex items-center gap-2 rounded-md border border-fl-border bg-fl-bg3 px-4 py-2.5 font-mono text-xs transition hover:border-fl-red"
                >
                  {swapData.repo_url}
                </a>
              )}
              {swapData?.description && (
                <div className="mx-auto mt-6 max-w-lg rounded-lg border border-fl-border border-l-[3px] border-l-fl-red/50 bg-fl-bg2 p-5 text-left">
