...
export default function ParallaxCrash() {
  ...
  const y5 = useTransform(scrollYProgress, [0, 1], ["-50%", "150%"]);
  ...
  return (
    <div ref={containerRef} className="h-[250vh] w-full relative overflow-hidden bg-black flex items-center justify-center border-t-[24px] border-b-[24px] border-white transform -skew-y-3 mb-32">
      <motion.div style={{ y: y1 }} className="absolute z-10 opacity-90 mix-blend-difference pointer-events-none">
        <h2 className="fl-display text-[25vw] tracking-tighter leading-none text-white uppercase whitespace-nowrap transform -rotate-12">
          SYSTEM ERROR
        </h2>
      </motion.div>
      
      <motion.div style={{ y: y2 }} className="absolute z-20 opacity-90 mix-blend-difference pointer-events-none">
        <h2 className="fl-display text-[20vw] tracking-tighter leading-none text-transparent uppercase whitespace-nowrap transform rotate-6" style={{ WebkitTextStroke: "6px #ff0000" }}>
          CORE DUMP
        </h2>
      </motion.div>
      ...
      <motion.div style={{ y: y5 }} className="absolute z-50 opacity-90 mix-blend-difference pointer-events-none">
        <h2 className="fl-display text-[40vw] tracking-tighter leading-none text-[#ff0000] uppercase whitespace-nowrap transform -rotate-6">
          CORRUPTION
        </h2>
      </motion.div>
    </div>
